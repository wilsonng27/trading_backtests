  ...
  - strategy_template_long_only_orb/: a template strategy folder built on top of
    that engine
  ...
  Example/template strategy package that imports backtest_template and shows how
  to:
